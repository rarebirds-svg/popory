...
def test_translate_aligns_each_language():
    def fake_runner(*, system_prompt, user_msg, parse, job_id, model=None):
...
def test_translate_length_mismatch_returns_none():
    ...
    def bad_runner(*, system_prompt, user_msg, parse, job_id, model=None):
...
def test_parse_rejects_wrong_length():
    import pytest
    captured = {}
    def runner(*, system_prompt, user_msg, parse, job_id, model=None):
