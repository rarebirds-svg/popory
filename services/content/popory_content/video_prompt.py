...
- image_prompt는 사물·풍경·정물·음식·자연 환경 위주로 묘사하고, **사람(얼굴·인물·신체 일부)은 절대 넣지 않습니다**. AI가 잘리거나 기형인 인체를 만들어 영상 품질을 심각하게 해칩니다. 인물 대신 관련 사물·장소·상징물로 장면을 표현합니다.
...
- image_prompt는 사물·풍경·정물·음식·자연 환경 위주로 묘사하고, **사람(얼굴·인물·신체 일부)은 절대 넣지 않습니다**. AI가 잘리거나 기형인 인체를 만들어 품질을 해칩니다. 인물 대신 관련 사물·장소·상징물로 표현합니다.
