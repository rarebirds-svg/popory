...
- image_prompt는 자연스러운 실사 장면을 묘사합니다. 사람이 등장해도 좋되, **인체가 해부학적으로 정상이고 온전하게(머리·손·신체가 잘리거나 기형이 되지 않게)** 표현되도록 합니다. 인물은 화면 안에 여백을 두고 자연스러운 거리(전신 또는 상반신)에서 담으며, 과도한 얼굴·손 클로즈업은 피합니다.
...
- image_prompt는 자연스러운 실사 장면을 묘사합니다. 사람이 등장해도 좋되, **인체가 해부학적으로 정상이고 온전하게(머리·손·신체가 잘리거나 기형이 되지 않게)** 표현되도록 합니다. 인물은 자연스러운 거리에서 담고 과도한 얼굴·손 클로즈업은 피합니다.
